...
// JWT creation/verification and refresh-token rotation helpers.
...
export const rotateRefreshToken = async (refreshToken, admin) => {
  ...
  await persistRefreshToken(admin.id, nextRefreshToken);

  const nextAccessToken = signAccessToken(admin);
