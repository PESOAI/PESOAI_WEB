...
// Authentication, session, admin profile, and audit controller handlers.
...
export const refresh = async (req, res) => {
  ...
  if (!refreshToken) {
    ...
    return res.status(HTTP.UNAUTHORIZED).json({ message: 'Missing refresh token' });
  }
  ...
  try {
    ...
    if (!rotated) {
      clearAuthCookies(res);
      return res.status(HTTP.UNAUTHORIZED).json({ message: 'Refresh token expired' });
    }
    ...
    clearAuthCookies(res);
    return res.status(HTTP.UNAUTHORIZED).json({ message: 'Invalid refresh token' });
  }
};
...
export const verify = async (req, res) => {
  ...
  if (!admin) {
    clearAuthCookies(res);
    return res.status(HTTP.UNAUTHORIZED).json({ message: 'Session not found' });
  }
...
export const updateAvatar = async (req, res) => {
  ...
  try {
    ...
    return res.status(HTTP.INTERNAL).json({ error: 'Unable to save avatar' });
  }
};
...
export const updateDisplayName = async (req, res) => {
  ...
  try {
    ...
    return res.status(HTTP.INTERNAL).json({ error: 'Unable to update display name' });
  }
};
...
export const getMe = async (req, res) => {
  try {
    ...
    return res.status(HTTP.INTERNAL).json({ error: 'Unable to fetch profile' });
  }
};
...
export const deleteAdmin = async (req, res) => {
  ...
  try {
    ...
    return res.status(HTTP.INTERNAL).json({ error: 'Unable to delete admin' });
  }
};
...
export const changePassword = async (req, res) => {
  ...
  try {
    ...
    return res.status(HTTP.INTERNAL).json({ error: 'Unable to change password' });
  }
};
...
export const getAuditLogs = async (_req, res) => {
  try {
    ...
    return res.status(HTTP.INTERNAL).json({ error: 'Unable to fetch audit logs' });
  }
};
...
export const createAuditLog = async (req, res) => {
  ...
  try {
    ...
    return res.status(HTTP.INTERNAL).json({ error: 'Unable to create audit log' });
  }
};
